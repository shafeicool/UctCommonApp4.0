...
public class MessageImageLayout extends MessageBaseLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    public MessageImageLayout(@NonNull Context context) {
        super(context);
        this.mContext = context;
    }

    public MessageImageLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }
    ...
    protected void initData() {
        ImageLoader.getInstance().displayImage("file://" + conversationMsg.getLocalImgPath(), iv_photo, BitmapUtil.imageVerticalOptions);
    }
