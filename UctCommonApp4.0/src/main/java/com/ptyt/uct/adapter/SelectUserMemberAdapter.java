...
public class SelectUserMemberAdapter extends BaseRecyAdapter<ContactUser> {

    public SelectUserMemberAdapter(Context context) {
        super(context);
    }
        ...
        viewHolder.tv_selectedUserName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onRemoveMemberChangedListener != null) {
                    onRemoveMemberChangedListener.onRemoveMemberChanged(contactUser);
                }
            }
        });
    }
    ...
    public interface OnRemoveMemberChangedListener {
        void onRemoveMemberChanged(ContactUser contactUser);
    }
}
