...
import com.ptyt.uct.utils.rom.HuaweiUtils;
import com.ptyt.uct.utils.rom.MeizuUtils;
import com.ptyt.uct.utils.rom.MiuiUtils;
import com.ptyt.uct.utils.rom.OppoUtils;
import com.ptyt.uct.utils.rom.QikuUtils;
import com.ptyt.uct.utils.rom.RomUtils;
...
public class FloatWindowManager {
    ...
    public void applyOrShowFloatWindow(Activity context) {
        if(context == null){return;}
        if (checkPermission(context)) {
            return;
//            UctApplication.getInstance().getGroupCallWindow().show(context);
        } else {
