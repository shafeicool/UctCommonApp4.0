...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        CallRecordDao.createTable(db, ifNotExists);
        ContactDao.createTable(db, ifNotExists);
        ContactFileDao.createTable(db, ifNotExists);
        ConversationDao.createTable(db, ifNotExists);
        ConversationMsgDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        CallRecordDao.dropTable(db, ifExists);
        ContactDao.dropTable(db, ifExists);
        ContactFileDao.dropTable(db, ifExists);
        ConversationDao.dropTable(db, ifExists);
        ConversationMsgDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(ContactFileDao.class);
        registerDaoClass(ConversationDao.class);
        registerDaoClass(ConversationMsgDao.class);
